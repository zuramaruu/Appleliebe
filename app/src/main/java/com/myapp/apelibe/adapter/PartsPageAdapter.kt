...
import com.myapp.apelibe.databinding.LayoutMarkdownBinding
import com.myapp.apelibe.databinding.LayoutYoutubeBinding
...
class PartsPageAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    class YoutubeViewHolder(private val youtubeBinding: LayoutYoutubeBinding) :
        ...
        fun bindItem(partPage: PartsPage) {
            youtubeBinding.ytContent.addYouTubePlayerListener(object :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return when (viewType) {
            TYPE_YOUTUBE -> {
                val youtubeBinding =
                    LayoutYoutubeBinding.inflate(LayoutInflater.from(parent.context), parent, false)
                YoutubeViewHolder(youtubeBinding)
            }
            else -> {
                val markdownBinding = LayoutMarkdownBinding.inflate(
